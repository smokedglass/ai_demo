...
//            }
    ...
    public Result checkFile() throws ExecutionException, InterruptedException {
        ...
        String result1 = "D:\\Projects\\backend3\\backend\\primaryFiles\\1000000000\\unchecked\\1000000000+20230830221304.docx,100140,5000,2,12061137";
        //String result2 = "D:\\Projects\\backend3\\backend\\primaryFiles\\1000000000\\unchecked\\1000000000+20230830221304.docx,100140,5.010168646820049E9,2,120611.37";
        ...
        for(String result : resultList){
            ...
            long totalMoney = Long.parseLong(resultOne[2]);
            long errTotalRows = Long.parseLong(resultOne[3]);
            long errTotalMoney = Long.parseLong(resultOne[4]);
            ...
            String errFileName = primaryFileName.split("\\.")[0] +"+" + "err.txt";
        ...
        //Todo 处理结束, 删除待扫描目录下的文件,移动到已扫描目录下
